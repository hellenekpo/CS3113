...
const char SPRITESHEET_FILEPATH[] = "assets/george_0.png"; // george
const char PLATFORM_FILEPATH[]    = "assets/platformPack_tile027.png"; // platfform
...
void initialise()
{
    ...
    state.player->set_acceleration(glm::vec3(0.0f, -0.01, 0.0f));
           ...
           /*
            case SDL_KEYUP:
                switch (event.key.keysym.sym) {
                    ...
                    case SDLK_LEFT:
                        // Drfiting left
                        state.player->set_acceleration(glm::vec3(-1.0f, 0.0f, 0.0f));
